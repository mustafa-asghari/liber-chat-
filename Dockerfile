...
RUN \
    ...
    # NOW copy workspace packages to node_modules AFTER all npm operations
    # This ensures npm doesn't remove them
    echo "Copying workspace packages to node_modules (after npm operations)..."; \
    ...
    # Final verification: ensure workspace packages exist and are accessible
    echo "Final verification of workspace packages..."; \
    test -f /app/node_modules/@librechat/data-schemas/dist/index.cjs || (echo "FATAL: data-schemas/dist/index.cjs missing!" && ls -la /app/node_modules/@librechat/ && ls -la /app/node_modules/@librechat/data-schemas/ 2>&1 && exit 1); \
    ...
    # Debug: list what's in node_modules/@librechat
    echo "Contents of /app/node_modules/@librechat:"; \
    ls -la /app/node_modules/@librechat/ || true; \
